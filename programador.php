...
class Pessoa
{
    ...
    public $nome;
    // A protected só pode ser chamada internamente pela classe, ex: método get, ou por quem herdar esta classe
    protected $idade;
...
class Programador extends Pessoa
{
    ...
    {
        /**
         *   Notice: Undefined property: Programador::$senha in E:\xampp\htdocs\cursophp7\programador.php on line 44
         *   Conforme explicado acima, programador herda de pessoa e nao tem acesso ao atributo privado SENHA
         */
