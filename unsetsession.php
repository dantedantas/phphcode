...
<p class="txt"><a href="createsession.php">CREATE SESSION</a> - <a href="session1.php">PAGE 1</a> - <a href="session2.php">PAGE 2</a> - <a href="destrosession.php">DESTROY SESSION</a></p>
<p class="txt">&nbsp;</p>
<p class="txt">--</p>
<p class="txt">&nbsp;</p>
